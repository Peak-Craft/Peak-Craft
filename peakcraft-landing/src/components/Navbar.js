    ...
    return (
      <nav className="bg-opacity-10 bg-black px-7 py-4 md:px-28 md:py-6 backdrop-blur-3xl fixed w-full z-40">
        <div className="flex justify-between items-center">
          ...
          <a href="/"><Image className='h-[30px] md:h-12 w-auto' src={require('../assets/images/logo.png')}/></a>
         ...
         {/* Menu button for small screens */}
          <div className={`${isOpen ? 'hidden' : ''} md:hidden`}>
            ...
            >
                <Image className='size-6' src={require('../assets/icons/Menu.png')}/>
            </button>
          </div>
        ...
        {/* navigation links */}
          ...
          >
            ...
            <button onClick={() => {setIsOpen(!isOpen)} }>
                <Image className={`${!isOpen ? 'hidden': ''} size-7 float-end`} src={require('../assets/icons/Close.png')}/>
            </button>
